    ...
    <main>
        ...
        <section id="pagamento" class="pix-section">
            ...
            <p class="pix-instruction" style="font-size: 0.85rem; margin-top: 25px;">
                💡 <strong>Dica Importante:</strong> Após realizar o pagamento por PIX ou Livepix, envie o comprovante para o nosso e-mail: <a href="matheuswandscher11@gmail.com" class="email-link">matheuswandscher11@gmail.com</a> para adicionarmos você ao grupo e liberarmos as suas recompensas!
            </p>
        </section>
